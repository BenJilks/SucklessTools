...
impl Screen {
    pub fn new(window_ref: Rc<RefCell<Window>>, font: Rc<RefCell<Font>>, page: i32) -> Self {
        ...
        let height: i32;
        {
            ...
            draw =
                unsafe { xft::XftDrawCreate(window.display, bitmap, window.visual, window.cmap) };
    ...
    pub fn resize(&mut self, width: i32, height: i32) {
        self.free();
        {
            ...
            self.draw = unsafe {
                xft::XftDrawCreate(window.display, self.bitmap, window.visual, window.cmap)
            };
        }
    ...
    pub fn draw_scroll(&mut self, amount: i32, top: i32, bottom: i32) {
        ...
        if amount < 0 {
            self.draw_scroll_down(-amount_pixels, top_pixels, bottom_pixels, height_pixels);
        } else {
            self.draw_scroll_up(amount_pixels, top_pixels, height_pixels);
        }
    }
